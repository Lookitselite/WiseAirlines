...
$query = $connect->prepare("Select employee_id, role, rate, hours from employees");
			...
			<div class="col-12 d-flex justify-content-center">
				<div class="card card-margin">
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<a class="nav-link" aria-current="page" href="adminAccount.php">Your Account</a>
						</li>

						<li class="nav-item">
							<a class="nav-link active" href="adminAccountEmployee.php">Employees</a>
						</li>

						<li class="nav-item">
							<a class="nav-link" href="adminAccountCustomers.php">Customers</a>
						</li>
                        ...
                        <div class="col-lg-12">
                            <div class="employees">
                                ...
                                <div class="employees-header">
                                    <div class="row">
                                        <div class="col-lg-6">
											<h3 class="text-center mt-5 pt-5 fw-bold">Account Information</h3>
											<hr>
                                        </div>
                                ...
                                <div class="employees-body">
									<div class="row">
                                        <div class="col-lg-6">
											<h5 class="text-center mt-5 pt-5 fw-bold">Transactions</h5>
											<hr>
                                        </div>
									...
									<!-- loop here for all transactions made on this account this is already created, on the accounts page--> 
									<?php
                                        ...
                                        <table class="table widget-26">
                                            <tbody>
                                                <tr><!-- The row we will loop for all employees, transactions, flights, tickets, accounts, will contain these table rows -->
                                                    ...
                                                    <td>
														<button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample' . htmlspecialchars($transaction['transaction_id']) . '" aria-expanded="false" aria-controls="collapseExample">
															Tickets
														</button>
														</p>
                                                    </td>
